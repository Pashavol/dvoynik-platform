...
const LUCIDE = {
  ...
  'play':           '<polygon points="5 3 19 12 5 21 5 3" fill="currentColor" stroke="currentColor"/>',
  ...
  'hard-hat':       '<path d="M2 20a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2.4"/><path d="M20 13c0-3.87-3.13-7-7-7a7 7 0 0 0-7 7"/><path d="M6 13v4c0 .55.45 1 1 1h10c.55 0 1-.45 1-1v-4"/><path d="M12 6V3"/><path d="M9 3h6"/>',
...
const Badge = ({ variant = 'default', children, uppercase = false }) => {
  ...
  const variants = {
    ...
    info: { background: 'var(--brand-muted)', color: 'var(--brand-muted-foreground)' },
